...
# Write PROMPT_V1 — concise, 2-4 sentence answers
SYSTEM_V1 = (
...
# Write PROMPT_V2 — structured, expert 3-5 sentence answers
SYSTEM_V2 = (
...
PROMPT_V1_NAME = "day22-rag-prompt-v1"   # TODO: choose a unique name
PROMPT_V2_NAME = "day22-rag-prompt-v2"   # TODO: choose a unique name
...
def main():
    ...
    # Print routing summary (how many went to V1 vs V2)
    print(f"\n📊 Routing summary:")
    print(f"   V1 (concise): {v1_count} queries")
    print(f"   V2 (structured): {v2_count} queries")
    print(f"✅ {len(SAMPLE_QUESTIONS)} additional traces sent to LangSmith")
